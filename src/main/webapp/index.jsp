...
<body>
  ...
  <aside class="sidebar">
    <div class="sidebar-brand">
      <div class="brand-icon"><span class="material-symbols-outlined" style="font-variation-settings:'FILL' 1">diamond</span></div>
      <div class="brand-text"><h1>Luminous</h1><p>Executive Suite</p></div>
    </div>
    <nav>
    ...
    <div class="sidebar-footer">
      ...
      <button class="btn btn-primary" style="width:100%;justify-content:center" onclick="toast('Support chat coming soon!','info')">Support</button>
    </div>
  </aside>
  ...
  <div class="main-content">
    ...
    <header class="topbar">
      ...
      <div class="topbar-right">
        <div style="display:flex;align-items:center;gap:16px;border-right:1px solid rgba(255,255,255,0.1);padding-right:24px">
